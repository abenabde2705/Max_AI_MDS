<template>
   ...
   <div class="footer-content">
     ...
     <div class="footer-column">
       ...
       <div class="social-links">
         <a href="#"><img src="../assets/icons8-instagram-50.png" alt="Instagram" class="social-icon"></a>
         <a href="#"><img src="../assets/icons8-tiktok-50.png" alt="Tiktok" class="social-icon"></a>
         <a href="#"><img src="../assets/icons8-twitter-50.png" alt="Twitter" class="social-icon"></a>
       </div>
     </div>
     ...
     <div class="footer-column">
       ...
       <p><a href="mailto:Max@outlook.com">Max@outlook.com</a></p>
     ...
     <div class="footer-column">
       ...
       <button>
         <img src="../assets/playstore-removebg-preview.png" alt="Logo Google Play" class="store-logo">
         Google Play
       </button>
     </div>
   </div>
  ...
  .footer {
    ...
    padding: 40px 10% 20px; /* Réduit de 80px à 40px */
    overflow: hidden;
    position: relative;
  }
