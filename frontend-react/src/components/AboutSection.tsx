    ...
    <section id={id} className={`about-section ${className} about-section--bg`} >
      <div data-aos="fade-up" data-aos-duration="200" data-aos-delay="100" className='about-section--bg' style={{ backgroundImage: `url(${bgUrl})` }}>
        ...
        <div className="features-container">
          <div className="feature-text">
            <h2>UNE ÉCOUTE SIMPLE,<br />DES RÉPONSES CLAIRES</h2>
             <p>Je m'adapte à vous, à votre personnalité et à vos besoins.<br /> Je retiens ce que vous partagez avec moi et j'évolue à vos côtés.<br /> Vous choisissez comment je communique : <br />bienveillant, direct ou neutre, c'est vous qui décidez.</p>
        <p>Besoin d'un avis ? Envoyez-moi une photo ou décrivez une <br />situation, je suis là pour vous guider et vous conseiller.</p>
          </div>
        </div>
      </div>
    </section>
